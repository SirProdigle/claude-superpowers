...
Task tool (general-purpose):
  ...
  prompt: |
    ...
    **Steps:**
    ...
    Code Areas section, VERBATIM, under a "### Area: <slug>" heading. Pass only the areas this
    task touches — an unused brief is re-read on every turn of this agent and buys nothing. If
    the plan has no ## Code Areas section, omit this subsection entirely.]
