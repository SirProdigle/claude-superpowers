...
digraph process {
    ...
    "Final review clean: delete this plan's workspace" -> "Use claude-superpowers:finishing-a-development-branch";
}
```
...
claude-superpowers:using-git-worktrees to create one or verify the existing one.
...
claude-superpowers:requesting-code-review's
...
Use claude-superpowers:finishing-a-development-branch.
...
Done! Using claude-superpowers:finishing-a-development-branch.
```
